...
<body>
	...
	<table>
		...
		<?php
			...
			$conn = mysqli_connect("localhost", "root", "", "dermatologist");
			...
			if (mysqli_num_rows($result) > 0) {
				...
				while($row = mysqli_fetch_assoc($result)) {
					...
					echo '<a href="accept4.php?id=' . $row["id"] . '"><button class="accept-btn">Accept</button></a>';
