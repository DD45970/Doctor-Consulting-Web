...
<body>
	<h1>Welcome Dr. Divya Choudhary</h1>
	...
	<table>
		...
		<?php
			...
			$conn = mysqli_connect("localhost", "root", "", "ophthalmologist");
			...
			if (mysqli_num_rows($result) > 0) {
				...
				while($row = mysqli_fetch_assoc($result)) {
					...
					echo '<a href="accept10.php?id=' . $row["id"] . '"><button class="accept-btn">Accept</button></a>';
